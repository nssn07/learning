...
var menuItemsUrl = "data/menu_items.json?category=";
	...
	//  alert(categories);
	 ...
	 alert(chosenCategoryShortName);
      ...
      // var chosenCategoryShortName = ....
       var randomhtml = insertProperty(homeHtml, "randomCategoryShortName", "'" + chosenCategoryShortName + "'");
     //  var randomhtml = insertProperty(homeHtml, "randomCategoryShortName", "'B'");
      ...
      // alert(randomhtml);
       var homeHtmlToInsertIntoMainPage =  insertHtml("#main-content", randomhtml);
